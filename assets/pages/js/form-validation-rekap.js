var Login=function(){
	var a=function(){
		$(".form-data").validate({
			...
			rules:{
				rekap_kerja_nama:{required:!0},
				rekap_kerja_data_kontrak:{required:!0},
				rekap_kerja_jangka_waktu:{required:!0},
				rekap_kerja_klien:{required:!0},
				rekap_kerja_data_klien:{required:!0},
				rekap_kerja_status:{required:!0},
				rekap_kerja_ket:{required:!0},
			},
