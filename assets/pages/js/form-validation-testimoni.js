var Login=function(){
	var a=function(){
		$(".form-data").validate({
			...
			rules:{
				testimoni_nama:{required:!0},
				testimoni_email:{required:!0,email:!0},
				testimoni_pekerjaan:{required:!0,email:!0},
				testimoni_testimoni:{required:!0},
				testimoni_ind:{required:!0},
			},
